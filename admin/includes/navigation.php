    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-item ">
        <a class="nav-link" href="">
          Users Online:
          <?php
          echo users_online() == 1 ? "<i class='bi bi-1-circle-fill text-success'></i>" : "<i class='bi bi-0-fill text-red'></i>";
          ?>
        </a>
      </li>
      ...
      <li class="nav-item dropdown no-arrow mx-1">
        <a class="nav-link dropdown-toggle" href="../admin/comments.php">
      ...
      <li class="nav-item dropdown no-arrow">
        ...
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
          <a class="dropdown-item" href="../admin/password.php">Settings</a>
